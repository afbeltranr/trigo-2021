...
the spectra recorded from 4000 to 400 cm-1 is reported in figure \@ref(fig:raw-data-plot). Due to a background correction procedure performed using the software of the spectrometer, there is noise information around 2400 cm -1, so we can reduce the spectra to a region of interest
