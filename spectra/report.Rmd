...
There are some variables with negative values, which, due to lambert burger beer law has no phisical meaning. hence, we can search for these variables in each subset by the following code.
